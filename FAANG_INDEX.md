...
|------|--------|--------|-------|-------------|
| log_parser_faang.py | Speed | 8.2s | 2.2s | 3.75x |
| log_parser_faang.py | Memory | 400MB | 10MB | 40x |
| system_health_faang.py | Speed | 1.8s | 0.62s | 2.9x |
| http_check_faang.sh | Speed | 3.6s | 0.5s | 7.2x |
| app_faang.py | Throughput | 1000/s | 3500/s | 3.5x |
