...
**Files**:
- [`solution.tf`](01-event-driven/problem-1/solution.tf) - EventBridge bus, rules, DLQ, archive, cross-account routing
- [`ride_service.py`](01-event-driven/problem-1/ride_service.py) - Ride creation with event publishing
- [`driver_service.py`](01-event-driven/problem-1/driver_service.py) - Driver assignment logic
- [`payment_service.py`](01-event-driven/problem-1/payment_service.py) - Payment processing
- [`fraud_detection.py`](01-event-driven/problem-1/fraud_detection.py) - Real-time fraud checks with idempotency
...
**Files**:
- [`solution.tf`](02-cqrs-saga/problem-1/solution.tf) - DynamoDB event store and read models
- [`command_handler.py`](02-cqrs-saga/problem-1/command_handler.py) - Command processing with event generation
- [`projector.py`](02-cqrs-saga/problem-1/projector.py) - Event projection to read models
- [`query_api.py`](02-cqrs-saga/problem-1/query_api.py) - Query handlers for read models
...
**Files**:
- [`scps.json`](03-multi-account/problem-1/scps.json) - 6 production SCPs
- [`account_factory.py`](03-multi-account/problem-1/account_factory.py) - Automated account provisioning
- [`solution.tf`](03-multi-account/problem-1/solution.tf) - Transit Gateway and networking
...
**Files**:
- [`solution.tf`](04-hybrid-cloud/problem-1/solution.tf) - Complete hybrid infrastructure
- [`README.md`](04-hybrid-cloud/problem-1/README.md) - Architecture and requirements
